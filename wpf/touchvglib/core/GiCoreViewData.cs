...
public class GiCoreViewData : MgView {
  ...
  internal GiCoreViewData(IntPtr cPtr, bool cMemoryOwn) : base(touchvgPINVOKE.GiCoreViewData_SWIGUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(GiCoreViewData obj) {
  ...
  public GiPlaying drawing {
    ...
    get {
      IntPtr cPtr = touchvgPINVOKE.GiCoreViewData_drawing_get(swigCPtr);
  ...
  public MgShapeDoc backDoc {
    ...
    get {
      IntPtr cPtr = touchvgPINVOKE.GiCoreViewData_backDoc_get(swigCPtr);
  ...
  public GiPlayShapes play {
    ...
    get {
      IntPtr cPtr = touchvgPINVOKE.GiCoreViewData_play_get(swigCPtr);
      GiPlayShapes ret = (cPtr == IntPtr.Zero) ? null : new GiPlayShapes(cPtr, false);
      return ret;
    } 
  }
  ...
  public new static GiCoreViewData fromHandle(int h) {
    IntPtr cPtr = touchvgPINVOKE.GiCoreViewData_fromHandle(h);
    GiCoreViewData ret = (cPtr == IntPtr.Zero) ? null : new GiCoreViewData(cPtr, false);
    return ret;
  }

  public MgRecordShapes recorder(bool forUndo) {
    IntPtr cPtr = touchvgPINVOKE.GiCoreViewData_recorder(swigCPtr, forUndo);
