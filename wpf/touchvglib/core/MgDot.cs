...
public class MgDot : MgBaseShape {
  ...
  internal MgDot(IntPtr cPtr, bool cMemoryOwn) : base(touchvgPINVOKE.MgDot_SWIGUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(MgDot obj) {
  ...
  public static MgDot create() {
    IntPtr cPtr = touchvgPINVOKE.MgDot_create();
    MgDot ret = (cPtr == IntPtr.Zero) ? null : new MgDot(cPtr, false);
    return ret;
  }
  ...
  public override MgObject clone() {
    IntPtr cPtr = touchvgPINVOKE.MgDot_clone(swigCPtr);
  ...
  public override bool isCurve() {
    bool ret = touchvgPINVOKE.MgDot_isCurve(swigCPtr);
    return ret;
  }
