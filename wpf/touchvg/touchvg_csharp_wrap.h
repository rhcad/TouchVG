...
public:
    ...
    typedef void (SWIGSTDCALL* SWIG_Callback15_t)(int, void *);
    typedef unsigned int (SWIGSTDCALL* SWIG_Callback16_t)();
    typedef unsigned int (SWIGSTDCALL* SWIG_Callback17_t)();
    typedef float (SWIGSTDCALL* SWIG_Callback18_t)(void *, float, void *);
    typedef unsigned int (SWIGSTDCALL* SWIG_Callback19_t)(void *);
    typedef unsigned int (SWIGSTDCALL* SWIG_Callback20_t)(int, void *, void *, int);
...
private:
    ...
    SWIG_Callback9_t swig_callbackupdate;
    SWIG_Callback10_t swig_callbacktransform;
    SWIG_Callback11_t swig_callbackclear;
    SWIG_Callback12_t swig_callbackclearCachedData;
    SWIG_Callback13_t swig_callbackgetPointCount;
    SWIG_Callback14_t swig_callbackgetPoint;
    SWIG_Callback15_t swig_callbacksetPoint;
    SWIG_Callback16_t swig_callbackisClosed;
    SWIG_Callback17_t swig_callbackisCurve;
    SWIG_Callback18_t swig_callbackhitTest;
    SWIG_Callback19_t swig_callbackhitTestBox;
    SWIG_Callback20_t swig_callbackdraw;
